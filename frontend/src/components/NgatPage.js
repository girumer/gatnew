...
const ngatAllExams = ['GAT1', 'GAT2', 'GAT3', 'GAT4','GAT5','GAT6' ,'GAT2SAMPLE', 'GAT3SAMPLE','GAT4SAMPLE','GAT5SAMPLE'];
const ngatSampleExams = ['GAT1SAMPLE', 'GAT2SAMPLE', 'GAT3SAMPLE','GAT4SAMPLE','GAT5SAMPLE'];
